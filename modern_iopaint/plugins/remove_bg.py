...
from modern_iopaint.schema import Device, RunPluginRequest, RemoveBGModel
...
class RemoveBG(BasePlugin):
    ...
    def _init_session(self, model_name: str):
        ...
        if model_name == RemoveBGModel.briaai_rmbg_1_4:
            from modern_iopaint.plugins.briarmbg import (
            ...
            from modern_iopaint.plugins.briarmbg2 import (
